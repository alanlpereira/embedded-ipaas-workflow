...
export const corporate21Templates: WorkflowTemplateItem[] = [
  // =========================================================================
  // 1. JURÍDICO (TEMPLATE OBRIGATÓRIO DETALHADO)
  // =========================================================================
  {
    id: 'tpl-jur-1',
  ...
  // =========================================================================
  // 3. LOGÍSTICA & SUPRIMENTOS (4 Templates)
  // =========================================================================
  {
    id: 'tpl-sup-1',
  ...
  // =========================================================================
  // 4. RH & GESTÃO DE PESSOAS (4 Templates)
  // =========================================================================
  {
    id: 'tpl-rh-1',
  ...
  // =========================================================================
  // 5. TI & INFRAESTRUTURA (4 Templates)
  // =========================================================================
  {
    id: 'tpl-ti-1',
  ...
  // =========================================================================
  // 6. MANUTENÇÃO & PREDIAL (3 Templates)
  // =========================================================================
  {
    id: 'tpl-man-1',
  ...
  // =========================================================================
  // 7. JURÍDICO COMPLEMENTAR (1 Template Extra)
  // =========================================================================
  {
    id: 'tpl-jur-2',
...
export async function runTemplateSeed() {
  ...
  console.log(`\n🎉 [SEED COMPLETO] ${countSuccess} de ${corporate21Templates.length} templates foram disponibilizados na Galeria!`);
}
