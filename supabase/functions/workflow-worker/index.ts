        ...
        const mockProcessesList = [
          {
            ...
            advocate: 'Advocacia Geral Corporativa',
            oab: '000000',
            uf: 'MG',
            notice: 'Fica o advogado cadastrado intimado para contestar a ação no prazo legal de 15 dias úteis, sob pena de revelia.',
            movement_text: 'Despacho/Intimação: Compulsando os autos, verifica-se que a petição inicial preenche os requisitos do art. 319 do CPC. Fica o patrono habilitado intimado para CITAR e INTIMAR a parte ré EBL Logística S.A. para apresentar contestação no prazo legal de 15 (quinze) dias úteis (art. 335, CPC), sob pena de revelia.',
          ...
          },
          {
            ...
            oab: '000000',
            uf: 'MG',
            notice: 'Intimação do advogado cadastrado para especificação de provas.',
            movement_text: 'Decisão Interlocutória: Tendo em vista que a conciliação restou infrutífera, intime-se o patrono para que, no prazo comum de 5 (cinco) dias úteis, especifique justificadamente as provas que pretendem produzir na instrução processual.',
          ...
          },
          {
            ...
            movement_text: 'Intimação Eletrônica: Fica o advogado constituído intimado da juntada de contestação e documentos pelo Estado de Minas Gerais, para que apresente Impugnação/Réplica no prazo legal de 15 (quinze) dias úteis, indicando provas suplementares.',
          ...
          },
          {
            ...
            oab: '000000',
            uf: 'MG',
            notice: 'Intimação do patrono para laudo pericial técnico.',
            movement_text: 'Notificação PJe: Fica o advogado habilitado intimado da juntada do laudo pericial técnico referente às condições de trabalho. Prazo sucessivo de 10 (dez) dias úteis para manifestação sobre as conclusões do perito.',
          ...
          },
          {
            ...
            movement_text: 'Despacho/Decisão: Detalhamento de ordem judicial de bloqueio via SISBAJUD juntado aos autos. Fica a parte executada intimada, na pessoa de seu patrono cadastrado, para ciência da penhora e interposição de Embargos à Execução no prazo de 15 (quinze) dias.',
