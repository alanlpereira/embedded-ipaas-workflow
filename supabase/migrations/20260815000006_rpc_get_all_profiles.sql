...
-- Description: Stored Procedure SECURITY DEFINER to bypass RLS for Master Admin Panel
-- ==============================================================================
...
-- 2. Conceder permissão explícita de execução da RPC para as roles da API Supabase
...
-- 3. Trigger opcional para criação automática de perfil ao registrar novo usuário em auth.users
...
-- Vincular o trigger à tabela auth.users se ainda não existir
